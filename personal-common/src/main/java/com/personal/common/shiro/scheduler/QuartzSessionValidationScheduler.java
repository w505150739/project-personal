package com.personal.common.shiro.scheduler;
...
/**
 * 基于quartz2.3.0+版本实现的定时验证Session任务
 * 解决quartz包冲突问题
 * 需在shiro配置：<bean id="sessionValidationScheduler" class="com.wiseyq.core.security.shiro.scheduler.QuartzSessionValidationScheduler">
 * @author huangga
 *
 */
