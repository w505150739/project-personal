package com.personal.generator.utils;
...
import com.personal.common.util.date.DateUtil;
import com.personal.generator.entity.ColumnEntity;
import com.personal.generator.entity.TableEntity;
...
public class GeneratorUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", DateUtil.getDateTime(new Date()));
